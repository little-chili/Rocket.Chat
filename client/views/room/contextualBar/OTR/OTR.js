		...
		<>
			...
			<VerticalBar.ScrollableContent p='x24'>
				...
				{isEstablishing && !isEstablished && isOnline && (
					<>
						{' '}
						<Box fontScale='p3'>{t('Please_wait_while_OTR_is_being_established')}</Box> <Throbber inheritColor />{' '}
					</>
				)}
				...
				{!isOnline && <Box fontScale='p4'>{t('OTR_is_only_available_when_both_users_are_online')}</Box>}
